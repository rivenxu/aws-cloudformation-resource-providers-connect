...
public class CreateHandler extends BaseHandlerStd {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        logger.log(String.format("Invoked CreateUserHierarchyGroupHandler with InstanceArn:%s ,UserHierarchyName:%s, " +
                "ParentGroupArn:%s", model.getInstanceArn(), model.getName(), model.getParentGroupArn()));

        return proxy.initiate("connect::createUserHierarchyGroup", proxyClient, model, callbackContext)
                .translateToServiceRequest(resourceModel -> translateToCreateUserHierarchyGroupRequest(resourceModel, tags))
    ...
    private CreateUserHierarchyGroupRequest translateToCreateUserHierarchyGroupRequest(final ResourceModel model, final Map<String, String> tags) {
